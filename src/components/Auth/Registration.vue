...
export default {
  ...
  computed: {
    nameErrors () {
      ...
      !this.$v.name.required && errors.push('Потрібeне ім\'я')
      !this.$v.name.minLength && errors.push('Ім\'я більше 3 символів')
      return errors
    },
    emailErrors () {
      const errors = []
    ...
    confirmPasswordErrors () {
      ...
      !this.$v.confirmPassword.required && errors.push('Потрібeн пароль')
      !this.$v.confirmPassword.minLength && errors.push('Пароль більше 6 символів')
      !this.$v.confirmPassword.checkpassword && errors.push('Пароль неправильний')
      return errors
    },
    loading() {
  ...
  validations: {
    ...
    confirmPassword: {
      ...
      checkpassword: function(e){
        return this.password === e ? true : false
      }
    }
  }
}
